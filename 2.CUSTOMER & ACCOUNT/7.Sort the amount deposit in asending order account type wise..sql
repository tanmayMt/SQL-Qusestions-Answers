...
insert into CUSTOMER values(004,"Pakhi Sen","Dabipur",394235);
...
insert into ACCOUNT values(378935,"Saving Account", 5607935);
insert into ACCOUNT values(315904,"Current Account",236509);
insert into ACCOUNT values(394235,"Saving Account", 436732);
insert into ACCOUNT values(604235,"Salary Account", 6508897);
...
insert into ACCOUNT values(500915,"Fixed Deposit Account",35540);

select accn_type,amount
from ACCOUNT
order by accn_type,amount
