...
insert into ACCOUNT values(500915,"Fixed Deposit Account",53650);

select ACCOUNT.accn_no,accn_type,amount,c_id,c_name,c_city
from ACCOUNT,CUSTOMER
where ACCOUNT.accn_no=CUSTOMER.accn_no
and amount > 1000000;